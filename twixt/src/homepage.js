    ...
    return(
        <nav>
            <ul className="listStyle">
                <li className="itemStyle"><Link to="/search">Search</Link></li>
                <li className="itemStyle"><Link to="/discussion">Discussions</Link></li>
                <li className="itemStyle"><Link to="/">Sign Out</Link></li>
            </ul>
        </nav>
    )
}
